...
Die Menüsprache von Exodus ist jene Sprache, auf die Kodi eingestllt ist
 ...
 **Auto-Update Funktion**. 
 Gibt es die in Exodus?? Wie geht das, im Hintergrund??
?? automatisch Änderungen *an Seiten* ??? ANTWORT Offen

**UrlResolver Auto-Update** Ist das in Exodus auuch so???
ANTWORT offen
...
*Desktop- Videos -Addons- Video Addons- Exodus*
*Kodi17: Desktop- Addons- Exodus*

Diese Exodus Update Funktion arbeitet Unabhängig von den KODI Einstellungen. 

Wenn in Kodi unter: 
Optionen-Einstellungen-Addons-Seitenmenü,Automatische Aktualisierung auf AUS gestellt ist wird Exodus trotzdem aktualisiert
...
????Nache einem Exodus Update werden auch neu hinzugefügte Seiten automatisch angezeigt???? ANTWORT Offen

### 2.4 Hosterwahl

Wenn Ihr im Menü z.B. Filme- Jahr- 2017- beliebigen Film auswählen- klickt, werden alle verfügbaren Hoster durchsucht.

Auch nachdem eine Suche gestartet wurde, werden alle verfügbaren Hoster angezeigt. 
Neben dem Hoster steht die Qualität des Streams HD, SD, CAM usw.
